    ...
    <div class="container-fluid">
        ...
        <div id="h">
            <div class="row justify-content-center">
                <h3 class="logo" style="margin-left:0">Hi, <?php echo $user["nome"]; ?></h3>
            </div>
            <nav class="responsive-navbar justify-content-center">
                    ...
                    echo "<section class='add-wrapper col-sm-12 justify-content-center'>
                            <div class='row add'>
                                <div class='col-sm-5 add-part' style='margin-bottom:10%;'>
                                    ...
                                    <span class='col-sm-3' style='height:fit-content;'>Code: </span>
                                    <input class='col-sm-6' type='number' id='nNomeCorso' style='margin-top:0%;margin-bottom:5%;' placeholder='Course code'>
                    ...
                    echo "<section class='add-wrapper col-sm-12 justify-content-center'>
                            <div class='row add'>
                                <div class='col-sm-6 add-part row'>
                                    <span class='add-title col-sm-12' style='height:7vh;margin-bottom:5vh;'>Course</span>
                                    <span class='col-sm-3' style='height:fit-content;'>Name: </span>
                                    <input class='col-sm-6' type='text' id='txtNomeCorso' style='margin-top:0%;margin-bottom:5%;' placeholder='Course name'>
                                    <span class='col-sm-12'></span>
                                    <span class='col-sm-4'></span>
                                    <span class='btn-grad sq col-sm-6' id='btnAddCourse' style='text-align:center;height:fit-content;'>Add: </span>
                                    <span class='col-sm-8 sq neutral-alert' id='addResults'>Enter the datas to create a new course or a new event!</span>
                                </div>
                            </div>
                        </section>";
                }
